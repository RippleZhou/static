        ...
        WeixinJSBridge.invoke(
            ...
            function (res) {
                if (res.err_msg == "get_brand_wcpay_request:ok") {
                    location.replace('/static/common/pay/success.html?serviceid='+Utils.queryParams.serviceid)
                } else {
                    diyalert('支付失败', 1000);
                }
            }
...
Pay.paymethod.offline = function (orderid,message,retrunurl) {
    ...
    $.get(geturl,function (rel) {
        var resulturl = '/static/common/pay/offline-result.html?message='+message+'&retrunurl='+retrunurl;
