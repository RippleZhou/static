!(function (window, $) {
    ...
    Services.getCategorys = function () {
        ...
        return Utils.ajax.get('/static/servicemall/api/serviceManifest.php', params, '/static/servicemall/json/categorys.json').then(appendChannel);
    ...
    Services.getService = function () {
        ...
        return Utils.ajax.get('/static/servicemall/api/serviceContentDetail.php', params, '/static/servicemall/json/services/' + params.categorytype + '.json').then(appendChannel);
